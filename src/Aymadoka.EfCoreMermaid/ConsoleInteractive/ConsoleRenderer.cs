...
namespace Aymadoka.EfCoreMermaid.ConsoleInteractive
{
    ...
    internal static class ConsoleRenderer
    {
        ...
        /// 渲染帮助信息到控制台
        /// </summary>
        internal static void RenderHelp()
        {
        ...
        internal static void RenderSuccess(string message)
        {
        ...
        /// </summary>
        /// <param name="message">要显示的消息</param>
        internal static void RenderError(string message)
        {
        ...
        internal static void RenderDiagramPreview(string diagram)
        {
