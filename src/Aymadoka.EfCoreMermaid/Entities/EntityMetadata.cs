...
namespace Aymadoka.EfCoreMermaid.Entities
{
    ...
    internal class EntityMetadata
    {
        ...
        /// 实体的属性元数据集合
        /// </summary>
        internal List<PropertyMetadata> Properties { get; private set; }

        /// <summary>
        /// 使用指定名称初始化 <see cref="EntityMetadata"/> 类的新实例
        /// </summary>
        /// <param name="name">实体名称</param>
        internal EntityMetadata(string name)
        {
            Name = name;
        ...
        internal EntityMetadata(string name, List<PropertyMetadata> properties)
        {
            Name = name;
        ...
        internal void AddProperty(PropertyMetadata property)
        {
